...
if __name__ == "__main__":
    ...
    parser.add_argument("--rep_file_path", type=str, default="../outputs/clustering/rep_model.npy", help = "File path for saving extracted representations")
    parser.add_argument("--num_clusters", type=int, default=10, help = "Number of clusters for KMeans")
    parser.add_argument("--output_dir", type=str, default="../outputs/clustering/", help = "File path for saving trained KMeans model")
